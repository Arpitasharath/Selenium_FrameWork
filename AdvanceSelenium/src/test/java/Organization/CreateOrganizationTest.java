...
import pom.CreateOrganizationPage;
...
//		login.loginToApp(USERNAME, PASSWORD);
		...
		String phnNum = elib.getExcelDataUsingFormatter("Sheet3", 0, 1);
		System.out.println(phnNum);
		String mailId = elib.getExcelData("Sheet3", 0, 2);
		System.out.println(mailId);

		// create organization data
		CreateOrganizationPage orgData = new CreateOrganizationPage(driver);
		orgData.enterOrgData(OrgName, phnNum, mailId);

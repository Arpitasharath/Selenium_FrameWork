...
public class task_PhoneNamesandPrices {
...
//	        int count=0;
//	        List phnNames = driver.findElements(By.xpath("//div[@class='KzDlHZ']"));
	//	
...
//		System.out.println("total num of count:----->"+count);
	//----------------------------------------------------------------------------------------------------------------------------------------
//	        int count=0;
//	       List phnPrice = driver.findElements(By.xpath("//div[@class='Nx9bqj _4b5DiR']"));
